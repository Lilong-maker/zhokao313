...
const (
	...
	Order_OrderGet_FullMethodName    = "/proto.Order/OrderGet"
...
func (c *orderClient) OrderGet(ctx context.Context, in *OrderGetReq, opts ...grpc.CallOption) (*OrderGetResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderGetResp)
	err := c.cc.Invoke(ctx, Order_OrderGet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedOrderServer) OrderGet(context.Context, *OrderGetReq) (*OrderGetResp, error) {
...
func _Order_OrderGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Order_OrderGet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).OrderGet(ctx, req.(*OrderGetReq))
	}
	return interceptor(ctx, in, info, handler)
}
